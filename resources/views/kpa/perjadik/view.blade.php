...
@push('myscript')
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location = "/kpa/perjalanan/diklat/batal/"+id_perjalanan
        }
      });
    });
    </script>
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location = "/kpa/perjalanan/diklat/setuju/"+id_perjalanan
        }
      });
    });
    </script>
    ...
    $(document).on('click', '.listpegawai', function () {
        ...
        $.ajax({
            type: 'POST',
            url: '/kpa/perjalanan/diklat/listpelaksana',
            data: {
                _token: "{{ csrf_token() }}",
