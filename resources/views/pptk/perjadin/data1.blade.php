                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade show active" id="status1" role="tabpanel">
                                            <div class="table-responsive">
                                                <table id="data-1" class="display" style="min-width: 1000px">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="dropdown">
								            						...
								            						<div class="dropdown-menu">
                                                                         @if ($d->status == '1')
                                                                        <a type="button" class="dropdown-item status" data-id="{{Crypt::encrypt($d->id_perjalanan)}}"> <i class="fa fa-send color-muted"></i> Submit</a>
