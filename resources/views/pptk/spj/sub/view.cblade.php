                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table style="color:black">
                                    <tr>
                                        <td style="width: 19%; padding-bottom:10px; vertical-align: top;">Tanggal Pengajuan</td>
                                                ...
                                                <div id="collapse{{$d->perjalanan->id_perjalanan}}"
                                                    ...
                                                    <div class="accordion-body-text">
                                                        <div class="mb-3 d-flex gap-2">
                                                            <a type="button" class="adduh btn btn-twitter btn-xs flex-fill"><i class="fa fa-plus"></i> Uang Harian</a>
                                                            <a type="button" class="addut btn btn-skype btn-xs flex-fill"><i class="fa fa-car"></i> Uang Transport</a>
                                                            <a type="button" class="addup btn btn-vimeo btn-xs flex-fill"><i class="fa fa-building"></i> Uang Penginapan</a>
                                                        </div>
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered table-responsive-sm" style="min-width: 1200px">
                                                                    <tr>
                                                                        <td style="text-align:center; color: black; font-size: 12px" rowspan="2">
                                                                    ...
                                                                    <tr>
                                                                        <td>
												                        	<div class="form-check custom-checkbox checkbox-success check-md me-3">
                                                                                <input type="checkbox" class="form-check-input checkItem" id="check{{$loop->index}}">
                                                                        ...
                                                                        <td style="text-align:center; color: black; font-size: 12px">@if($r->uang_harian == NULL) Rp0 @else {{$r->uang_harian}} @endif</td>
                                                                        <td style="text-align:center; color: black; font-size: 12px"> @if($r->uang_transport == NULL) Rp0 @else {{$r->uang_transport}} @endif</td>
                                                                        <td style="text-align:center; color: black; font-size: 12px"> @if($r->uang_penginapan == NULL) Rp0 @else {{$r->uang_penginapan}} @endif</td>
