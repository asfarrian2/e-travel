        ...
        @endif
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item">Perjalanan Diklat</li>
					</ol>
                </div>

                @include('pptk.perjadik.data1')
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title">Tambah Perjalanan Diklat</h3>
                                <button type="button" class="btn-close" data-bs-dismiss="modal">
                                </button>
                            </div>
                            <div class="modal-body">
                                <div class="basic-form">
                                    <form action="{{ route('a.perjadik')}}" method="POST">
                                    @csrf    
                ...
                <!-- End Modal Tambah Dalam Daerah -->
                            ...
                            <div class="modal fade" id="modal-addpegawai">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title">Tambah Peserta Diklat</h3>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal">
                                            </button>
                                        </div>
                            ...
                            <div class="modal fade" id="modal-listpegawai">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title">List Peserta Diklat</h3>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal">
                                            </button>
                                        </div>
...
document.addEventListener("change", function(e) {
    ...
    <script>
     $('#tujuan').select2({
            ...
            dropdownParent: $('#tambahdata2'),
            width: '100%',
            ajax: {
                url: "{{ route('get.tujuan') }}",
                dataType: 'json',
                delay: 250,
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.length === 0) {
                    $('#kanggaran')
                        .html('<option value="">Data Anggaran Tidak Tersedia</option>')
                        .trigger('change');
                    return;
                }
                let grouped = {};
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location = "/perjalanan/dinas/hapus/"+id_perjalanan
      }
    });
    });
    </script>
    ...
    $(document).on('click', '.addpegawai', function () {
        ...
        $.ajax({
            type: 'POST',
            url: '/perjalanan/diklat/addpelaksana',
            cache: false,
            data: {
                _token: "{{ csrf_token() }}",
                id_perjalanan: id_perjalanan
...
$(document).on('click', '.listpegawai', function () {
    ...
    $.ajax({
        type: 'POST',
        url: '/perjalanan/diklat/listpelaksana',
        data: {
            _token: "{{ csrf_token() }}",
            id_perjalanan: id_perjalanan
        },
