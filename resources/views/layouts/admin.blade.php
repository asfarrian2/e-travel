				...
				<ul class="metismenu" id="menu">
					<li class="dropdown header-profile">
						...
						<div class="dropdown-menu dropdown-menu-end">
							...
							<a href="w" class="dropdown-item ai-icon">
                    ...
                    <li>
                        <a class="ai-icon" href="/admin/dashboard" aria-expanded="false" @if(Request::is('admin/dashboard*')) style="background-color: #eefaf9;" @endif>
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false" @if(Request::is('admin/kegiatan*')) style="background-color: #eefaf9;" @endif>
							<i class="flaticon-039-goal"></i>
							<span class="nav-text">Kegiatan</span>
						</a>
                        <ul aria-expanded="false" @if(Request::is('admin/kegiatan*')) class="mm-collapse mm-show" @endif>
                            <li @if(Request::is('admin/kegiatan/subkegiatan*')) class="mm-active" @endif><a href="/admin/kegiatan/subkegiatan" @if(Request::is('admin/kegiatan/subkegiatan*')) class="mm-active" @endif>Sub Kegiatan</a></li>
                            <li @if(Request::is('admin/kegiatan/koderekening*')) class="mm-active" @endif><a href="/admin/kegiatan/koderekening" @if(Request::is('admin/kegiatan/koderekening*')) class="mm-active" @endif>Kode Rekening</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="ai-icon" href="/admin/anggarandasar" aria-expanded="false">
							<i class="flaticon-007-bulleye"></i>
							<span class="nav-text">Anggaran Dasar</span>
						</a>
                    </li>
                    <li><a href="javascript:void()" class="has-arrow ai-icon" aria-expanded="false"  @if(Request::is('admin/pelaksana*')) style="background-color: #eefaf9;" @endif>
                        ...
                        <ul aria-expanded="false" @if(Request::is('admin/pelaksana*')) class="mm-collapse mm-show" @endif>
                            <li @if(Request::is('admin/pelaksana/pegawai*')) class="mm-active" @endif><a href="/admin/pelaksana/pegawai" @if(Request::is('admin/pelaksana/pegawai*')) class="mm-active" @endif>Pegawai</a></li>
                            <li @if(Request::is('admin/pelaksana/narasumber*')) class="mm-active" @endif><a href="/admin/pelaksana/narasumber" @if(Request::is('admin/pelaksana/narasumber*')) class="mm-active" @endif>Narasumber</a></li>
                            <li @if(Request::is('admin/pelaksana/peserta*')) class="mm-active" @endif><a href="/admin/pelaksana/peserta" @if(Request::is('admin/pelaksana/peserta*')) class="mm-active" @endif>Peserta</a></li>
                        </ul>
                    </li>
                    <div class="copyright">
                    <p><strong>Manage</strong></p>
                    </div>
                    <li><a class="ai-icon" href="/admin/akun" aria-expanded="false">
