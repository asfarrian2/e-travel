        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="ai-icon" href="/dashboard" aria-expanded="false" @if(Request::is('dashboard*')) style="background-color: #eefaf9;" @endif>
                    ...
                    <li>
                        <a class="ai-icon" href="/anggaran" aria-expanded="false" @if(Request::is('anggaran*')) style="background-color: #eefaf9;" @endif>
