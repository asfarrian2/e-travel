        ...
        @endif
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item">Anggaran Dasar</li>
					</ol>
                </div>
                <!-- row -->
                 <div class="row">
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        @foreach ($tahun as $d)
                                            <tr>
                                                ...
                                                <td style="color: black; text-align:center;">{{$d->tahun}}</td>
                                                <td style="color: black;">Nomor {{$d->dpa}}<br>Tanggal {{$d->tgl_dpa}}</td>
                                                @if ($d->status == '0')
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    window.location = "/admin/anggarandasar/status"+id_tahun
    }
  });
});
</script>
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    window.location = "/admin/anggarandasar/hapus"+id_tahun
  }
});
});
</script>
...
<!-- Button Tambah DPA -->
<script>
$(document).on('click', '.dpaadd', function(){
    var id_tahun = $(this).attr('data-id');
    $.ajax({
                    type: 'POST',
                    url: '/admin/anggarandasar/dpa',
                    cache: false,
                    data: {
                        _token: "{{ csrf_token() }}",
                        id_tahun: id_tahun
...
<!-- Button Edit DPA -->
<script>
$(document).on('click', '.dpaedit', function(){
    var id_dpa = $(this).attr('data-id');
    $.ajax({
                    type: 'POST',
                    url: '/admin/anggarandasar/dpa/edit',
                    cache: false,
                    data: {
                        _token: "{{ csrf_token() }}",
                        id_dpa: id_dpa
...
<!-- Start Button Hapus -->
<script>
$(document).on('click', '.hapusdpa', function(){
    var id_dpa = $(this).attr('data-id');
Swal.fire({
  title: "Apakah Anda Yakin Data Ini Ingin Di Hapus ?",
  text: "Jika Ya Maka Data Akan Terhapus Permanen",
  ...
  if (result.isConfirmed) {
    window.location = "/admin/anggarandasar/dpa/hapus"+id_dpa
  }
});
});
</script>
