        ...
        @endif
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item">Akun Pengguna</li>
					</ol>
                </div>
                <!-- row -->
                 <div class="row">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="basic-form">
                                                <form action="{{ route('a.akun')}}" method="POST">
                                                @csrf
                                                <div class="mb-3">
                                                    ...
                                                    <option value="{{ Crypt::encrypt($d->id_pelaksana) }}">{{$d->nip }} - {{$d->nama }}</option>
                                                    @endforeach
                                                    </select>
                                                </div>    
                                                <div class="mb-3">
                                                    <label class="form-label">Nama Panggilan :</label>
                                                    <input type="text" name="nickname" class="form-control input-default" required>
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <td>
                                                    <div class="dropdown">
														...
														<div class="dropdown-menu">
															<a type="button" class="dropdown-item edit" data-id="{{Crypt::encrypt($d->id)}}"> <i class="fa fa-pencil color-muted"></i> Edit</a>
															<a type="button" class="dropdown-item hapus" data-id="{{Crypt::encrypt($d->id)}}" ><i class="fa fa-trash color-muted"></i> Hapus</a>
														</div>
													</div>
                                                </td>
                                            @endforeach
...
@push('myscript')
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location = "/admin/akun/hapus"+id
      }
    });
    });
    </script>
